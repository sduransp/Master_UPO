def startDataflowProcess2(data, context):
     ...
     inputFile = 'gs://tweets-ml/' + str(data['name'])
     #user defined parameters to pass to the dataflow pipeline job
     parameters = {
          'javascriptTextTransformFunctionName': 'transform',
          'javascriptTextTransformGcsPath':'gs://ml-flow-iwine/transform.js',
          'JSONPath': 'gs://ml-flow-iwine/Schema.json',
          'inputFilePattern': inputFile,
          'outputTable': 'iwine-tfm:ml_insights.tweets',
          'bigQueryLoadingTemporaryDirectory':'gs://ml-flow-iwine/temp/BQ_temp'
     }
